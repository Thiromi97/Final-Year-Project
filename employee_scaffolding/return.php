...
$sql = "SELECT * FROM returned LIMIT $rowsPerPage OFFSET $offset";
...
<body id="page-top">
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #2D3F50;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="return.php"><i class="fas fa-archive"></i><span>Return</span></a>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form method="GET" action="return_search.php">
                                        <label class="form-label">
                                            <input type="search" class="form-control form-control-sm" aria-controls="dataTable" placeholder="Return Id" name="returnId">
                                        </label>
                                ...
                                <table class="table my-0" id="dataTable">
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result)) {
                                            echo "<tr> 
                                                    ...
                                                    <td>
                                                    <button class='btn btn-danger btn-circle ms-1 edit-item-btn' data-item-code='" . $row["returnId"] . "' role='button' href='#' style='background: #3ab795;border-color: #3ab795;'>
                                            <i class='fas fa-pencil-alt text-white' style='font-size: 16px;'></i>
                                        </button>
                                    </td>
                                    <td>
                                    <button class='btn btn-danger btn-circle ms-1 delete-item-btn' data-item-code='" . $row["returnId"] . "'>
                                ...
                                <div class="col-md-6">
                                    <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        ...
                                        <?php
                                            ...
                                            $sql = "SELECT COUNT(*) AS count FROM returned";
    ...
    addButton.addEventListener('click', function(event) {
        ...
        window.open('return_add.php', 'Popup Window', `width=${width},height=${height},left=${left},top=${top}`);
    });
</script>
...
<script>
    ...
    editButtons.forEach(function(editButton) {
        editButton.addEventListener('click', function(event) {
            ...
            window.open(`return_edit.php?returnId=${returnId}`, 'Popup Window', `width=${width},height=${height},left=${left},top=${top}`);
        });
    });
</script>
...
<script>
    ...
    deleteButtons.forEach(function(deleteButton) {
        deleteButton.addEventListener('click', function(event) {
            ...
            const returnId = deleteButton.getAttribute('data-item-code');
            ...
            if (confirmed) {
                window.location.href = `return_delete.php?itemCode=${returnId}`;
            }
        });
    });
</script>
