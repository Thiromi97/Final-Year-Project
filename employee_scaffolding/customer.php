        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: #2D3F50;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="scaffolding_login.php"><i class="fas fa-sign-out-alt" style="font-size: 13px;"></i><span>LogOut</span></a></li>
                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table my-0" id="dataTable">
                                    ...
                                    if (!is_null($permissions) && is_array($permissions)) {
                                        // Edit button
                                        if (trim($permissions['can_edit']) === 'Yes') {
                                            echo "<td><button class='btn btn-danger btn-circle ms-1 edit-item-btn' data-item-code='" . $row["customerCode"] . "' role='button' href='#' style='background: #3ab795;border-color: #3ab795;'>
                                            <i class='fas fa-pencil-alt text-white'></i>
                                        </button></td>";
                                        } else {
                                            echo "<td><button class='btn btn-danger btn-circle ms-1 edit-item-btn' data-item-code='" . $row["customerCode"] . "' role='button' href='#' style='background: #ccc; border-color: #ccc;' disabled>
                                        ...
                                        if (trim($permissions['can_delete'] )=== 'Yes') {
                                            echo "<td><button class='btn btn-danger btn-circle ms-1 delete-item-btn' data-item-code='" . $row["customerCode"] . "'>
                                            <i class='fas fa-trash text-white'></i>
                                        </button></td>";
                                        } else {
                                            echo "<td><button class='btn btn-danger btn-circle ms-1 delete-item-btn' data-item-code='" . $row["customerCode"] . "' style='background: #ccc; border-color: #ccc;' disabled>
