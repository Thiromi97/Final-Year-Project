                            ...
                            <div class="col-lg-6" style="height: 518.025px;">
                                <div class="p-5" style="height: 518.65px;">
                                    ...
                                    <form class="user" style="height: 298.6px;">
                                        ...
                                        <div class="mb-3"><input class="form-control form-control-user" type="password" id="exampleInputPassword" placeholder="Password" name="password" style="margin-bottom: 20px;font-size: 15px;"></div><button class="btn btn-primary d-block btn-user w-100" type="submit" style="background: #782c25;margin-bottom: 60px;font-size: 15px;">Login</button>
                                        <hr>
                                        <div style="text-align: center;"><a class="small" href="forgot-password.html" style="font-size: 15px;color: #782c25;">Forgot Password?</a></div>
