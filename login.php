                            ...
                            <div class="col-lg-6" style="height: 518.025px;">
                                <div class="p-5" style="height: 518.65px;">
                                    ...
                                    <form class="user" action="" method="post" style="height: 298.6px;">
                                        <div class="mb-3">
                                            <input class="form-control form-control-user" type="text"  placeholder="Username" name="username" required="" style="margin-bottom: 20px;margin-top: 71px;font-size: 15px;">
                                        </div>
                                        <div class="mb-3">
                                            <input class="form-control form-control-user" type="password"  placeholder="Password" name="password" style="margin-bottom: 20px;font-size: 15px;">
                                        </div>
                                        ...
                                        <a class="small" href="forgot_password.php" style="font-size: 15px;color: #782c25;">Forgot Password?</a>
                                    </div>
