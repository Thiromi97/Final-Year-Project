...
$sqls = "SELECT * FROM userpermissions LIMIT $rowsPerPages OFFSET $offsets";
                            ...
                            <div class="col-md-6 text-nowrap">
                                <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable"><label class="form-label">Show&nbsp;
                                    <select class="d-inline-block form-select form-select-sm" onchange="location.href = '?rowsPerPage=' + this.value;">
                                            <option value="10" <?php if ($rowsPerPage == 10) echo "selected"; ?></option>10</option>
...
<button class='btn btn-danger btn-circle ms-1 delete-item-btn' data-item-code='" . $row["id"] . "'>
    <i class='fas fa-trash text-white' style='font-size: 17px;'></i>
                ...
                <td>
                <button class='btn btn-danger btn-circle ms-1 edit-item-btn' data-item-code='" . $rows["userId"] . "' role='button' href='#' style='background: #3ab795;border-color: #3ab795;'>
        <i class='fas fa-pencil-alt text-white' style='font-size: 16px;'></i>
    </button>
</td>
<td>
<button class='btn btn-danger btn-circle ms-1 delete-item-btn' data-item-code='" . $rows["userId"] . "'>
    <i class='fas fa-trash text-white' style='font-size: 17px;'></i>
</button>
</td>
            </tr>";
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                    ...
                                    <?php
                                            // Get the total number of records
                                            $query = "SELECT COUNT(*) AS count FROM userpermissions";
